...
public class ProfilingHomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.layoutProfilingFarmer.setOnClickListener(v -> {
            //navigation to step 1
            navController.navigate(R.id.action_profilingHomeFragment_to_profilingFarmerFragment3);
        });

        binding.layoutProfilingAssociation.setOnClickListener(v -> navController.navigate(R.id.action_profilingHomeFragment_to_profilingAssociationFragment2));

        binding.layoutAgroInputDealer.setOnClickListener(v -> navController.navigate(R.id.action_profilingHomeFragment_to_profilingAgroInputDealersFragment2));

        binding.layoutDashboardBulkBuyers.setOnClickListener(v -> navController.navigate(R.id.action_profilingHomeFragment_to_profilingBulkBuyersFragment2));
    }
}