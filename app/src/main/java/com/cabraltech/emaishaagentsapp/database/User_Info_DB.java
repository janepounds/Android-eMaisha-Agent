...
public class User_Info_DB {
    ...
    public void insertUserData(LoginResponseData user){
        ...
        values.put(CUSTOMERS_TELEPHONE,       user.getPhone_number());
        values.put(CUSTOMERS_PICTURE,         user.getPicture());
    ...
    public LoginResponseData getUserData(String userID){
        // get and open SQLiteDatabase Instance from static method of DB_Manager class
        db = DB_Manager.getInstance().openDatabase();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                userInfo.setPhone_number(cursor.getString(6));
               //userInfo.setGender(cursor.getString(7));
                userInfo.setPicture(cursor.getString(8));
    ...
    public void updateUserData(LoginResponseData user){
        // get and open SQLiteDatabase Instance from static method of DB_Manager class
        db = DB_Manager.getInstance().openDatabase();
    ...
    public void updateUserPassword(LoginResponseData user){
        // get and open SQLiteDatabase Instance from static method of DB_Manager class
        db = DB_Manager.getInstance().openDatabase();
